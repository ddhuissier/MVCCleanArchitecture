...
using CleanArchitectureApp.Core.ProjectAggregate.Events;
using CleanArchitectureApp.Core.ProjectAggregate.Handlers;
using Moq;
using System;
...
namespace CleanArchitectureApp.UnitTests.Core.Handlers
{
